.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_demos_Video_Processing.py>`     to download the full example code or to run this example in your browser via Binder
...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "D:\Users\David\anaconda3\lib\site-packages\sphinx_gallery\gen_gallery.py", line 159, in call_memory
        return 0., func()
      File "D:\Users\David\anaconda3\lib\site-packages\sphinx_gallery\gen_rst.py", line 466, in __call__
        exec(self.code, self.fake_main.__dict__)
      File "D:\Users\David\GitHub\StoneSoup\docs\demos\Video_Processing.py", line 104, in <module>
        from stonesoup.reader.video import VideoClipReader
      File "D:\Users\David\GitHub\StoneSoup\stonesoup\reader\video.py", line 19, in <module>
        raise ImportError(
    ImportError: Usage of video processing classes requires that the optionalpackage dependencies 'moviepy' and 'ffmpeg-python' are installed. This can be achieved by running 'python -m pip install stonesoup[video]'
